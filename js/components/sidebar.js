...
export function initSidebar(activePage = '') {
    ...
    const sidebarHTML = `
        <aside class="dashboard-sidebar" id="dashboardSidebar">
            <div class="sidebar-header">
                <div class="sidebar-logo">SAMASTORE</div>
            </div>
            ...
            <nav class="sidebar-nav" id="mainNav">
                ...
                <a href="#" data-route="profil.html" class="sidebar-nav-link ${pageName === 'profil' ? 'active' : ''}">Profil</a>
            </nav>

            <div class="sidebar-footer">
                <a href="#" data-route="abonnements.html" class="sidebar-plan-badge" id="userPlan" title="Gérer mon abonnement" style="background: #f7f7f5; color: #37352f; border: 1px solid #e5e5e3;">${(session.subscription_plan || 'free').toUpperCase()}</a>
            </div>
        </aside>
    `;
    ...
    // Liens conditionnels selon le plan
